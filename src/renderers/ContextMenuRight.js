...
export const computePosition = ({ windowLayout, triggerLayout, optionsLayout }) => {
    ...
    const right = axisPosition(oWidth, wWidth, tX - wX, tWidth);
    return { top, right };
};

export default class ContextMenuRight extends React.Component {
...
// public exports
ContextMenuRight.computePosition = computePosition;
